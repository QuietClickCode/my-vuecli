...
export default {
    ...
    methods: {
        handleClose: function () {
            ...
            axios({
                url:process.env.HOST+ '/deletemarkdown',
                method: 'post',
                data: {
        ...
        updatemarkdown: function () {
            var vueThis = this
            axios({
                url: process.env.HOST+'/updatemarkdown',
                method: 'post',
                data: {
        ...
        query: function () {
            var vueThis = this
            axios({
                url:process.env.HOST+'/queryMarkdownList',
                method: 'post',
            ...
            axios({
                url: process.env.HOST+'/queryMarkdownListCount',
                method: 'post',
                data: vueThis.queryForm,
            })
                .then(function (response) {
